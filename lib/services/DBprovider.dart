...
*/
  Future<int> insert1(Cart cart) async {
    Database db = await instance.database;
...
//view cart page
  ...
  Future<List<Map<String, dynamic>>> queryDetails() async {
    ...
    var result = await db.rawQuery(
        'select $table1.$columnId,$table1.$columnCode,$table1.$columnImage, $table1.$columnDesc,$table1.$columnPrice,$table1.$columnQuantity,$table1.$columnTotal '
        'from $table1');
    return result;
  }
